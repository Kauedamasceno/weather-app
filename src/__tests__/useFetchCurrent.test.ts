...
export const dataMock = {
  ...
  export const restHandlers = [
    http.get(`https://api.openweathermap.org/data/2.5/weather?q=${searchInput}&appid=${searchKey}&units=metric`, () => {
...
describe("useSearchWeather", () => {
  ...
  it('should handle 404 error', async () => {
    server.use(
      http.get('https://api.openweathermap.org/data/2.5/weather?q=nonexistent&appid=${searchKey}&units=metric', () => {
