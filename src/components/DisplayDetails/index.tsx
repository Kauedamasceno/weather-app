...
const DisplayDetails = () => {
  ...
  if (search)
    return (
      <>
        <p className="mb-10">Detalhes do clima...</p>
        <div className="h-full flex flex-col justify-around max-md:justify-between max-md:gap-16 ">
          <h2 className="w-full mb-14 text-2xl font-bold text-center max-md:mb-7 ">
            {search.weather[0].description.toUpperCase()}
          </h2>
          <div className="flex justify-between">
            <p className="text-xl font-bold">Temp max</p>
            <span className="flex items-center text-xl font-bold">
              {Math.floor(search.main.temp_max)}&deg;
              <svg
          ...
          <div className="flex justify-between">
            <p className="text-xl font-bold">Temp min</p>
            <span className="flex items-center text-xl font-bold">
              {Math.floor(search.main.temp_min)}&deg;
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
          ...
          <div className="flex justify-between">
            <p className="text-xl font-bold">Humidade</p>
            <span className="flex items-center text-xl font-bold">
              {Math.floor(search.main.humidity)}%
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
          ...
          <div className="flex justify-between">
            <p className="text-xl font-bold">Nuvens</p>
            <span className="flex items-center text-xl font-bold">
              {Math.floor(search.clouds.all)}%
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
          ...
          <div className="flex justify-between">
            <p className="text-xl font-bold">Vento</p>
            <span className="flex items-center text-xl font-bold">
              {Math.floor(search.wind.speed)}km/h
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
